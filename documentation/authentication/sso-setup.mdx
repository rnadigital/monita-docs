...
**Important:** You must create the OAuth application first, as the configuration details will be needed for the Monita SSO setup.
...
**Important:** After creating your OAuth configuration, you must contact the Monita platform admin to add your organization's email domains to the SSO configuration.
...
- A user onboarding record is created with `skipOnboarding: true`
